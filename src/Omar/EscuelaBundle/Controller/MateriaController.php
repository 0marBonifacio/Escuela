...
use Omar\EscuelaBundle\Entity\Materia;
use Omar\EscuelaBundle\Form\MateriaType;
...
class MateriaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('OmarEscuelaBundle:Materia')->findAll();
     ...
     * @Method("POST")
     * @Template("OmarEscuelaBundle:Materia:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('OmarEscuelaBundle:Materia')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("OmarEscuelaBundle:Materia:edit.html.twig")
     */
