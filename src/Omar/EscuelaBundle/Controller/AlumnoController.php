...
use Omar\EscuelaBundle\Entity\Alumno;
use Omar\EscuelaBundle\Form\AlumnoType;
...
class AlumnoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('OmarEscuelaBundle:Alumno')->findAll();
     ...
     * @Method("POST")
     * @Template("OmarEscuelaBundle:Alumno:new.html.twig")
     */
    ...
    */
    private function createCreateForm(Alumno $entity)
    {
        ...
        $form->add('submit', 'submit', array('label' => 'Agregar alumno'));
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('OmarEscuelaBundle:Alumno')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("OmarEscuelaBundle:Alumno:edit.html.twig")
     */
